...
Note: Any place where :raw-html-m2r:`<variable>` is used should be replaced by the user with the appropriate variable.

Update: This is an `extended cheat sheet <http://www.yolinux.com/TUTORIALS/GDB-Commands.html>`_ I found useful.
...
To start gdb, type "gdb :raw-html-m2r:`<filename>`\ " where :raw-html-m2r:`<filename>` is the name of the compiled file you wish to debug (the name you type to run your program).
...
To help you get familiar with gdb this repo includes a full gdb exercise `here <GDBExercise.md>`_
