...
#define LL_SYSCFG_BANKMODE_BANK1                                                                 \
    0x00000000U /*!< Flash Bank 1 base address mapped at 0x0800 0000 (AXI) and 0x0020 0000 (TCM) \
                   and Flash Bank 2 base address mapped at 0x0810 0000 (AXI) and 0x0030 0000     \
                   (TCM)*/

#define LL_SYSCFG_BANKMODE_BANK2                                                               \
    SYSCFG_MEMRMP_SWP_FB /*!< Flash Bank 2 base address mapped at 0x0800 0000 (AXI) and 0x0020 \
...
#define LL_SYSCFG_TIMBREAK_PVD                                                                 \
    SYSCFG_CBR_PVDL /*!< Enables and locks the PVD connection with TIMER1, TIMER8 Break input. \
 ...
 * @retval None
 */
__STATIC_INLINE void LL_FLASH_EnableART(void) { SET_BIT(FLASH->ACR, FLASH_ACR_ARTEN); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_FLASH_DisableART(void) { CLEAR_BIT(FLASH->ACR, FLASH_ACR_ARTEN); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_FLASH_EnableARTReset(void) { SET_BIT(FLASH->ACR, FLASH_ACR_ARTRST); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_FLASH_DisableARTReset(void) { CLEAR_BIT(FLASH->ACR, FLASH_ACR_ARTRST); }
