...
typedef struct {
    ...
    uint32_t DataAlign; /*!< Specifies ADC data alignment to right (MSB on register bit 11 and LSB
                           ...
                           MSB on register bit 14 and LSB on register bit 3).
    ...
    uint32_t
        ScanConvMode;      /*!< Configures the sequencer of regular and injected groups.
                              ...
                              direction is upward: from rank1 to rank 'n'.      This parameter can be a value
                              of @ref ADC_Scan_mode.      This parameter can be set to ENABLE or DISABLE */
    ...
    uint32_t ContinuousConvMode; /*!< Specifies whether the conversion is performed in single mode
    ...
    uint32_t NbrOfConversion; /*!< Specifies the number of ranks that will be converted within the
                                 regular group sequencer. To use regular group sequencer and convert
                                 several ranks, parameter 'ScanConvMode' must be enabled. This
    ...
    uint32_t
        NbrOfDiscConversion;   /*!< Specifies the number of discontinuous conversions in which the
                                  main sequence of regular group (parameter NbrOfConversion) will be
                                  subdivided.   If parameter 'DiscontinuousConvMode' is disabled, this
                                  parameter is discarded.   This parameter must be a number between
    ...
    FunctionalState
        DMAContinuousRequests; /*!< Specifies whether the DMA requests are performed in one shot
                                  mode (DMA transfer stop when number of conversions is reached) or
                                  in Continuous mode (DMA transfer unlimited, whatever number of
                                  conversions). Note: In continuous mode, DMA must be configured in
                                  circular mode. Otherwise an overrun will be triggered when DMA
                                  buffer maximum pointer is reached. Note: This parameter must be
                                  ...
                                  mode or external trigger that could launch a conversion). This
...
typedef struct {
    ...
    uint32_t
        SamplingTime; /*!< Sampling time value to be set for the selected channel.
                         ...
                         function of ADC clock frequency and sampling time setting)
                                 Refer to device datasheet for timings values, parameters
