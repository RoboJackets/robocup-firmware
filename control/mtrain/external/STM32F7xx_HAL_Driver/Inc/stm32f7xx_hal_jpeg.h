...
typedef struct {
    ...
    uint32_t
        ChromaSubsampling; /*!< Chroma Subsampling in case of YCBCR or CMYK color space, 0-> 4:4:4 ,
                              1-> 4:2:2, 2 -> 4:1:1, 3 -> 4:2:0 This parameter can be a value of
                              @ref JPEG_ChromaSubsampling */
...
#endif /* (USE_HAL_JPEG_REGISTER_CALLBACKS) */
{
    ...
    uint8_t*
        pJpegOutBuffPtr; /*!< Pointer to JPEG processing (encoding, decoding,...) output buffer */
    ...
    uint8_t CustomQuanTable; /*!< If set to 1 specify that user customized quantization tables are
                                used */
