...
typedef struct {
    ...
    uint32_t
        FilterFIFOAssignment; /*!< Specifies the FIFO (0 or 1) which will be assigned to the filter.
                                   This parameter can be a value of @ref CAN_filter_FIFO */

    uint32_t
        FilterNumber; /*!< Specifies the filter which will be initialized.
    ...
    uint32_t
        BankNumber; /*!< Select the start slave bank filter.
...
typedef struct {
    ...
    uint8_t
        Data[8]; /*!< Contains the data to be transmitted.
...
typedef struct {
    ...
    uint8_t
        Data[8]; /*!< Contains the data to be received.
                      This parameter must be a number between Min_Data = 0 and Max_Data = 0xFF */

    uint32_t
        FMI; /*!< Specifies the index of the filter the message stored in the mailbox passes
                through. This parameter must be a number between Min_Data = 0 and Max_Data = 0xFF */
