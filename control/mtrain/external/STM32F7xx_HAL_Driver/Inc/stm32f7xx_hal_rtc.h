...
#define __HAL_RTC_ALARM_GET_IT(__HANDLE__, __INTERRUPT__)                                       \
    ((((((__HANDLE__)->Instance->ISR) & ((__INTERRUPT__) >> 4U)) & 0x0000FFFFU) != RESET) ? SET \
                                                                                          : RESET)
...
#define IS_RTC_HOUR_FORMAT(__FORMAT__) \
    (((__FORMAT__) == RTC_HOURFORMAT_12) || ((__FORMAT__) == RTC_HOURFORMAT_24))
#define IS_RTC_OUTPUT_POL(__POL__) \
    (((__POL__) == RTC_OUTPUT_POLARITY_HIGH) || ((__POL__) == RTC_OUTPUT_POLARITY_LOW))
#define IS_RTC_OUTPUT_TYPE(__TYPE__) \
    (((__TYPE__) == RTC_OUTPUT_TYPE_OPENDRAIN) || ((__TYPE__) == RTC_OUTPUT_TYPE_PUSHPULL))
...
#define IS_RTC_HOURFORMAT12(__PM__) \
    (((__PM__) == RTC_HOURFORMAT12_AM) || ((__PM__) == RTC_HOURFORMAT12_PM))
#define IS_RTC_DAYLIGHT_SAVING(__SAVE__)                                                     \
    (((__SAVE__) == RTC_DAYLIGHTSAVING_SUB1H) || ((__SAVE__) == RTC_DAYLIGHTSAVING_ADD1H) || \
     ((__SAVE__) == RTC_DAYLIGHTSAVING_NONE))
#define IS_RTC_STORE_OPERATION(__OPERATION__) \
    (((__OPERATION__) == RTC_STOREOPERATION_RESET) || ((__OPERATION__) == RTC_STOREOPERATION_SET))
#define IS_RTC_FORMAT(__FORMAT__) \
    (((__FORMAT__) == RTC_FORMAT_BIN) || ((__FORMAT__) == RTC_FORMAT_BCD))
...
#define IS_RTC_WEEKDAY(__WEEKDAY__)                                                         \
    (((__WEEKDAY__) == RTC_WEEKDAY_MONDAY) || ((__WEEKDAY__) == RTC_WEEKDAY_TUESDAY) ||     \
     ((__WEEKDAY__) == RTC_WEEKDAY_WEDNESDAY) || ((__WEEKDAY__) == RTC_WEEKDAY_THURSDAY) || \
     ((__WEEKDAY__) == RTC_WEEKDAY_FRIDAY) || ((__WEEKDAY__) == RTC_WEEKDAY_SATURDAY) ||    \
...
#define IS_RTC_ALARM_DATE_WEEKDAY_SEL(__SEL__) \
    (((__SEL__) == RTC_ALARMDATEWEEKDAYSEL_DATE) || ((__SEL__) == RTC_ALARMDATEWEEKDAYSEL_WEEKDAY))
...
#define IS_RTC_ALARM_SUB_SECOND_MASK(__MASK__)         \
    (((__MASK__) == RTC_ALARMSUBSECONDMASK_ALL) ||     \
     ...
     ((__MASK__) == RTC_ALARMSUBSECONDMASK_SS14) || ((__MASK__) == RTC_ALARMSUBSECONDMASK_NONE))
