...
typedef struct {
    ...
    uint32_t
        DAC_OutputBuffer; /*!< Specifies whether the DAC channel output buffer is enabled or
                             disabled. This parameter can be a value of @ref DAC_output_buffer */
...
#define DAC_TRIGGER_NONE                                                                          \
    0x00000000UL /*!< Conversion is automatic once the DAC1_DHRxxxx register has been loaded, and \
