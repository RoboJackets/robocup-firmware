         ...
         : ((__CHANNEL__) == LL_TIM_CHANNEL_CH1N)                              \
               ...
               : ((__CHANNEL__) == LL_TIM_CHANNEL_CH2)                         \
                     ...
                     : ((__CHANNEL__) == LL_TIM_CHANNEL_CH2N)                  \
                           ? 3U                                                \
                           : ((__CHANNEL__) == LL_TIM_CHANNEL_CH3)             \
                                 ? 4U                                          \
                                 : ((__CHANNEL__) == LL_TIM_CHANNEL_CH3N)      \
                                       ? 5U                                    \
...
#define LL_TIM_DMABURST_BASEADDR_OR \
    (TIM_DCR_DBA_4 | TIM_DCR_DBA_2) /*!< TIMx_OR register is the DMA base address for DMA burst */
...
#define LL_TIM_TIM5_TI4_RMP_LSI                                                                   \
    (TIM5_OR_TI4_RMP_0 | TIM5_OR_RMP_MASK) /*!< TIM5 channel 4 is connected to LSI internal clock \
                                            */
...
#define LL_TIM_TIM5_TI4_RMP_RTC                                                                   \
    (TIM5_OR_TI4_RMP | TIM5_OR_RMP_MASK) /*!< TIM5 channel 4 is connected to RTC wakeup interrupt \
                                          */
/**
 * @}
 */
 ...
 * @retval None
 */
__STATIC_INLINE void LL_TIM_EnableBRK(TIM_TypeDef* TIMx) { SET_BIT(TIMx->BDTR, TIM_BDTR_BKE); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_TIM_DisableBRK(TIM_TypeDef* TIMx) { CLEAR_BIT(TIMx->BDTR, TIM_BDTR_BKE); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_TIM_EnableBRK2(TIM_TypeDef* TIMx) { SET_BIT(TIMx->BDTR, TIM_BDTR_BK2E); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_TIM_DisableBRK2(TIM_TypeDef* TIMx) { CLEAR_BIT(TIMx->BDTR, TIM_BDTR_BK2E); }
