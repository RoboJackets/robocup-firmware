...
#define LL_RTC_TAMPER_ACTIVELEVEL_TAMP1                                                         \
    RTC_TAMPCR_TAMP1TRG /*!< RTC_TAMP1 input falling edge (if TAMPFLT = 00) or staying high (if \
                           TAMPFLT != 00) triggers a tamper detection event*/
#define LL_RTC_TAMPER_ACTIVELEVEL_TAMP2                                                         \
    RTC_TAMPCR_TAMP2TRG /*!< RTC_TAMP2 input falling edge (if TAMPFLT = 00) or staying high (if \
                           TAMPFLT != 00) triggers a tamper detection event*/
#define LL_RTC_TAMPER_ACTIVELEVEL_TAMP3                                                         \
    RTC_TAMPCR_TAMP3TRG /*!< RTC_TAMP3 input falling edge (if TAMPFLT = 00) or staying high (if \
                           TAMPFLT != 00) triggers a tamper detection event*/
/**
 * @}
 */
...
#define LL_RTC_WAKEUPCLOCK_CKSPRE_WUT                                                              \
    (RTC_CR_WUCKSEL_2 | RTC_CR_WUCKSEL_1) /*!< ck_spre (usually 1 Hz) clock is selected and 2exp16 \
...
__STATIC_INLINE uint32_t LL_RTC_TS_GetDate(RTC_TypeDef* RTCx) {
    return (uint32_t)(
        READ_BIT(RTCx->TSDR, RTC_TSDR_WDU | RTC_TSDR_MT | RTC_TSDR_MU | RTC_TSDR_DT | RTC_TSDR_DU));
}
