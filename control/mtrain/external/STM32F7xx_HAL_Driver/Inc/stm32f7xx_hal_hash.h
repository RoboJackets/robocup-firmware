 ...
 * @param __HANDLE__ HASH handle.
 * @retval SET (handle phase is set to HASH processing) or RESET (handle phase is not set to HASH
 * processing)
 */
 ...
 * @param __HANDLE__ HASH handle.
 * @retval SET (handle phase is set to HMAC processing) or RESET (handle phase is not set to HMAC
 * processing)
 */
