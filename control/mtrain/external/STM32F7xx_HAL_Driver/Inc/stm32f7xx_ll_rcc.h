...
#define LL_RCC_I2C4_CLKSOURCE_PCLK1 \
    (uint32_t)(RCC_DCKCFGR2_I2C4SEL | 0x00000000U) /*!< PCLK1 clock used as I2C4 clock source */
...
#define LL_RCC_I2C4_CLKSOURCE_HSI     \
    (uint32_t)(RCC_DCKCFGR2_I2C4SEL | \
               (RCC_DCKCFGR2_I2C4SEL_1 >> 16U)) /*!< HSI clock used as I2C4 clock source */
#endif                                          /* I2C4 */
/**
 * @}
 */
...
#define LL_RCC_SAI1_CLKSOURCE_PLLSAI \
    (uint32_t)(RCC_DCKCFGR1_SAI1SEL | 0x00000000U) /*!< PLLSAI clock used as SAI1 clock source */
...
#define LL_RCC_SAI1_CLKSOURCE_PIN                                \
    (uint32_t)(RCC_DCKCFGR1_SAI1SEL | (RCC_DCKCFGR1_SAI1SEL_1 >> \
                                       16U)) /*!< External pin clock used as SAI1 clock source */
...
#define LL_RCC_SAI2_CLKSOURCE_PLLSAI \
    (uint32_t)(RCC_DCKCFGR1_SAI2SEL | 0x00000000U) /*!< PLLSAI clock used as SAI2 clock source */
...
#define LL_RCC_SAI2_CLKSOURCE_PIN                                \
    (uint32_t)(RCC_DCKCFGR1_SAI2SEL | (RCC_DCKCFGR1_SAI2SEL_1 >> \
                                       16U)) /*!< External pin clock used as SAI2 clock source */
...
#define LL_RCC_SDMMC1_CLKSOURCE_SYSCLK  \
    (uint32_t)(RCC_DCKCFGR2_SDMMC1SEL | \
               (RCC_DCKCFGR2_SDMMC1SEL >> 16U)) /*!< System clock clock used as SDMMC1 clock */
#if defined(SDMMC2)
