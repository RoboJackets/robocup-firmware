...
typedef struct {
    ...
    uint32_t
        ByteSelectStart; /*!< Specifies if the data to be captured by the interface is even or odd
    ...
    uint32_t
        LineSelectStart; /*!< Specifies if the line of data to be captured by the interface is even
                            or odd This parameter can be a value of @ref DCMI_Line_Select_Start */
#endif
} DCMI_InitTypeDef;
...
#define DCMI_OEBS_ODD                                                                            \
    ((uint32_t)0x00000000U) /*!< Interface captures first data from the frame/line start, second \
                               one being dropped */
#define DCMI_OEBS_EVEN                                                                            \
    ((uint32_t)DCMI_CR_OEBS) /*!< Interface captures second data from the frame/line start, first \
                                one being dropped */
...
#define DCMI_OELS_ODD                                                                           \
    ((uint32_t)0x00000000U) /*!< Interface captures first line from the frame start, second one \
                               being dropped */
#define DCMI_OELS_EVEN                                                                           \
    ((uint32_t)DCMI_CR_OELS) /*!< Interface captures second line from the frame start, first one \
                                being dropped */
