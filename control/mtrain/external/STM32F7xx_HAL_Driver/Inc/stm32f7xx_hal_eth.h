...
typedef struct {
    ...
    uint32_t
        PassControlFrames; /*!< Sets the forwarding mode of the control frames (including unicast
                              and multicast PAUSE frames) This parameter can be a value of @ref
...
#define ETH_MAX_PACKET_SIZE                                                                      \
    ((uint32_t)1524U) /*!< ETH_HEADER + ETH_EXTRA + ETH_VLAN_TAG + ETH_MAX_ETH_PAYLOAD + ETH_CRC \
                       */
...
#define ETH_DMATXDESC_ES                                                                           \
    ((uint32_t)0x00008000U) /*!< Error summary: OR of the following bits: UE || ED || EC || LCO || \
                               NC || LCA || FF || JT */
...
#define ETH_DMARXDESC_ES                                                                           \
    ((uint32_t)0x00008000U) /*!< Error summary: OR of the following bits: DE || OE || IPC || LC || \
                               RWT || RE || CE */
...
#define ETH_DMARXDESC_RWT                                                                          \
    ((uint32_t)0x00000010U) /*!< Receive Watchdog Timeout: watchdog timer expired during reception \
                             */
...
#define ETH_DMARXDESC_MAMPCE                                                                       \
    ((uint32_t)0x00000001U) /*!< Rx MAC Address/Payload Checksum Error: Rx MAC address matched/ Rx \
...
#define ETH_DMAPTPRXDESC_PTPMT_PDELAYRESP_MANAG                                                  \
    ((uint32_t)0x00000600U) /* PdelayResp message (peer-to-peer transparent clock) or Management \
                               message (Ordinary or Boundary clock)  */
...
#define ETH_PASSCONTROLFRAMES_FORWARDALL                                                          \
    ((uint32_t)0x00000080U) /*!< MAC forwards all control frames to application even if they fail \
                               the Address Filter */
...
#define ETH_TXDMABURSTLENGTH_1BEAT                                                                \
    ((uint32_t)0x00000100U) /*!< maximum number of beats to be transferred in one TxDMA (or both) \
                               transaction is 1 */
#define ETH_TXDMABURSTLENGTH_2BEAT                                                                \
    ((uint32_t)0x00000200U) /*!< maximum number of beats to be transferred in one TxDMA (or both) \
                               transaction is 2 */
#define ETH_TXDMABURSTLENGTH_4BEAT                                                                \
    ((uint32_t)0x00000400U) /*!< maximum number of beats to be transferred in one TxDMA (or both) \
                               transaction is 4 */
#define ETH_TXDMABURSTLENGTH_8BEAT                                                                \
    ((uint32_t)0x00000800U) /*!< maximum number of beats to be transferred in one TxDMA (or both) \
                               transaction is 8 */
#define ETH_TXDMABURSTLENGTH_16BEAT                                                               \
    ((uint32_t)0x00001000U) /*!< maximum number of beats to be transferred in one TxDMA (or both) \
                               transaction is 16 */
#define ETH_TXDMABURSTLENGTH_32BEAT                                                               \
    ((uint32_t)0x00002000U) /*!< maximum number of beats to be transferred in one TxDMA (or both) \
                               transaction is 32 */
#define ETH_TXDMABURSTLENGTH_4XPBL_4BEAT                                                          \
    ((uint32_t)0x01000100U) /*!< maximum number of beats to be transferred in one TxDMA (or both) \
                               transaction is 4 */
#define ETH_TXDMABURSTLENGTH_4XPBL_8BEAT                                                          \
    ((uint32_t)0x01000200U) /*!< maximum number of beats to be transferred in one TxDMA (or both) \
                               transaction is 8 */
#define ETH_TXDMABURSTLENGTH_4XPBL_16BEAT                                                         \
    ((uint32_t)0x01000400U) /*!< maximum number of beats to be transferred in one TxDMA (or both) \
                               transaction is 16 */
#define ETH_TXDMABURSTLENGTH_4XPBL_32BEAT                                                         \
    ((uint32_t)0x01000800U) /*!< maximum number of beats to be transferred in one TxDMA (or both) \
                               transaction is 32 */
#define ETH_TXDMABURSTLENGTH_4XPBL_64BEAT                                                         \
    ((uint32_t)0x01001000U) /*!< maximum number of beats to be transferred in one TxDMA (or both) \
                               transaction is 64 */
#define ETH_TXDMABURSTLENGTH_4XPBL_128BEAT                                                        \
    ((uint32_t)0x01002000U) /*!< maximum number of beats to be transferred in one TxDMA (or both) \
                               transaction is 128 */
/**
 * @}
 */
...
#define ETH_DMATXDESC_CHECKSUMTCPUDPICMPFULL                                                     \
    ((uint32_t)0x00C00000U) /*!< TCP/UDP/ICMP checksum fully in hardware including pseudo header \
                             */
/**
 * @}
 */
...
#define ETH_MMC_IT_TGFSC \
    ((uint32_t)0x00004000U) /*!< When Tx good single col counter reaches half the maximum value */
/**
 * @}
 */
...
#define ETH_MMC_IT_RFAE \
    ((uint32_t)0x10000040U) /*!< When Rx alignment error counter reaches half the maximum value */
