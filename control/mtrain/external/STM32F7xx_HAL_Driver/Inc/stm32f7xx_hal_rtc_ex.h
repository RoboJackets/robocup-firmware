...
#define RTC_TAMPERFILTER_2SAMPLE                             \
    ((uint32_t)0x00000800U) /*!< Tamper is activated after 2 \
                                consecutive samples at the active level */
#define RTC_TAMPERFILTER_4SAMPLE                             \
    ((uint32_t)0x00001000U) /*!< Tamper is activated after 4 \
                                consecutive samples at the active level */
#define RTC_TAMPERFILTER_8SAMPLE                             \
    ((uint32_t)0x00001800U) /*!< Tamper is activated after 8 \
...
#define RTC_TAMPERSAMPLINGFREQ_RTCCLK_DIV16384                         \
    ((uint32_t)0x00000100U) /*!< Each of the tamper inputs are sampled \
                                with a frequency =  RTCCLK / 16384 */
#define RTC_TAMPERSAMPLINGFREQ_RTCCLK_DIV8192                          \
    ((uint32_t)0x00000200U) /*!< Each of the tamper inputs are sampled \
                                with a frequency =  RTCCLK / 8192  */
#define RTC_TAMPERSAMPLINGFREQ_RTCCLK_DIV4096                          \
    ((uint32_t)0x00000300U) /*!< Each of the tamper inputs are sampled \
                                with a frequency =  RTCCLK / 4096  */
#define RTC_TAMPERSAMPLINGFREQ_RTCCLK_DIV2048                          \
    ((uint32_t)0x00000400U) /*!< Each of the tamper inputs are sampled \
                                with a frequency =  RTCCLK / 2048  */
#define RTC_TAMPERSAMPLINGFREQ_RTCCLK_DIV1024                          \
    ((uint32_t)0x00000500U) /*!< Each of the tamper inputs are sampled \
                                with a frequency =  RTCCLK / 1024  */
#define RTC_TAMPERSAMPLINGFREQ_RTCCLK_DIV512                           \
    ((uint32_t)0x00000600U) /*!< Each of the tamper inputs are sampled \
                                with a frequency =  RTCCLK / 512   */
#define RTC_TAMPERSAMPLINGFREQ_RTCCLK_DIV256                           \
    ((uint32_t)0x00000700U) /*!< Each of the tamper inputs are sampled \
...
#define RTC_TAMPERPRECHARGEDURATION_2RTCCLK                         \
    ((uint32_t)0x00002000U) /*!< Tamper pins are pre-charged before \
                                sampling during 2 RTCCLK cycles */
#define RTC_TAMPERPRECHARGEDURATION_4RTCCLK                         \
    ((uint32_t)0x00004000U) /*!< Tamper pins are pre-charged before \
                                sampling during 4 RTCCLK cycles */
#define RTC_TAMPERPRECHARGEDURATION_8RTCCLK                         \
    ((uint32_t)0x00006000U) /*!< Tamper pins are pre-charged before \
...
#define RTC_TIMESTAMPONTAMPERDETECTION_ENABLE \
    ((uint32_t)RTC_TAMPCR_TAMPTS) /*!< TimeStamp on Tamper Detection event saved        */
...
#define RTC_TAMPER_PULLUP_ENABLE \
    ((uint32_t)0x00000000U) /*!< TimeStamp on Tamper Detection event saved        */
#define RTC_TAMPER_PULLUP_DISABLE \
    ((uint32_t)RTC_TAMPCR_TAMPPUDIS) /*!< TimeStamp on Tamper Detection event is not saved */
/**
 * @}
 */
...
#define RTC_SMOOTHCALIB_PERIOD_32SEC                                      \
    ((uint32_t)0x00000000U) /*!< If RTCCLK = 32768 Hz, Smooth calibration \
                                period is 32s,  else 2exp20 RTCCLK seconds */
#define RTC_SMOOTHCALIB_PERIOD_16SEC                                      \
    ((uint32_t)0x00002000U) /*!< If RTCCLK = 32768 Hz, Smooth calibration \
                                period is 16s, else 2exp19 RTCCLK seconds */
#define RTC_SMOOTHCALIB_PERIOD_8SEC                                       \
    ((uint32_t)0x00004000U) /*!< If RTCCLK = 32768 Hz, Smooth calibration \
...
#define RTC_SMOOTHCALIB_PLUSPULSES_SET                                    \
    ((uint32_t)0x00008000U) /*!< The number of RTCCLK pulses added        \
...
#define __HAL_RTC_TAMPER_GET_IT(__HANDLE__, __INTERRUPT__)                                     \
    (((__INTERRUPT__) == RTC_IT_TAMP1)                                                         \
         ? (((((__HANDLE__)->Instance->ISR) & ((__INTERRUPT__) >> 3)) != RESET) ? SET : RESET) \
         : ((__INTERRUPT__) == RTC_IT_TAMP2)                                                   \
               ? (((((__HANDLE__)->Instance->ISR) & ((__INTERRUPT__) >> 5)) != RESET) ? SET    \
                                                                                      : RESET) \
               : (((((__HANDLE__)->Instance->ISR) & ((__INTERRUPT__) >> 7)) != RESET) ? SET    \
                                                                                      : RESET))
...
#define __HAL_RTC_INTERNAL_TIMESTAMP_CLEAR_FLAG(__HANDLE__, __FLAG__)              \
    ((__HANDLE__)->Instance->ISR) = (~(((__FLAG__) | RTC_ISR_INIT) & 0x0003FFFF) | \
...
#define RTC_EXTI_LINE_TAMPER_TIMESTAMP_EVENT                                                       \
    ((uint32_t)EXTI_IMR_IM21) /*!< External interrupt line 21 Connected to the RTC Tamper and Time \
                                 Stamp events */
#define RTC_EXTI_LINE_WAKEUPTIMER_EVENT                                                          \
    ((uint32_t)EXTI_IMR_IM22) /*!< External interrupt line 22 Connected to the RTC Wake-up event \
                               */
/**
 * @}
 */
...
#define IS_RTC_OUTPUT(__OUTPUT__)                                                   \
    (((__OUTPUT__) == RTC_OUTPUT_DISABLE) || ((__OUTPUT__) == RTC_OUTPUT_ALARMA) || \
     ((__OUTPUT__) == RTC_OUTPUT_ALARMB) || ((__OUTPUT__) == RTC_OUTPUT_WAKEUP))
#define IS_RTC_BKP(__BKP__) ((__BKP__) < (uint32_t)RTC_BKP_NUMBER)
#define IS_TIMESTAMP_EDGE(__EDGE__) \
    (((__EDGE__) == RTC_TIMESTAMPEDGE_RISING) || ((__EDGE__) == RTC_TIMESTAMPEDGE_FALLING))
#define IS_RTC_TAMPER(__TAMPER__)                                                 \
    ((((__TAMPER__) & ((uint32_t)(0xFFFFFFFFU ^ RTC_TAMPCR_TAMPXE))) == 0x00U) && \
     ((__TAMPER__) != (uint32_t)RESET))

#define IS_RTC_TAMPER_INTERRUPT(__INTERRUPT__)                                      \
    ((((__INTERRUPT__) & (uint32_t)(0xFFFFFFFFU ^ RTC_TAMPCR_TAMPXIE)) == 0x00U) && \
     ((__INTERRUPT__) != (uint32_t)RESET))

#define IS_RTC_TIMESTAMP_PIN(__PIN__)                                                   \
    (((__PIN__) == RTC_TIMESTAMPPIN_DEFAULT) || ((__PIN__) == RTC_TIMESTAMPPIN_POS1) || \
...
#define IS_RTC_SHIFT_ADD1S(__SEL__) \
    (((__SEL__) == RTC_SHIFTADD1S_RESET) || ((__SEL__) == RTC_SHIFTADD1S_SET))
#define IS_RTC_SHIFT_SUBFS(__FS__) ((__FS__) <= 0x00007FFF)
#define IS_RTC_CALIB_OUTPUT(__OUTPUT__) \
    (((__OUTPUT__) == RTC_CALIBOUTPUT_512HZ) || ((__OUTPUT__) == RTC_CALIBOUTPUT_1HZ))
/**
 * @}
 */
