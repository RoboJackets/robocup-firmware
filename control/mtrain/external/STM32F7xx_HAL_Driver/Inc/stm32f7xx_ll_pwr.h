...
#define LL_PWR_MODE_STOP_MAINREGU_UNDERDRIVE                                                      \
    (PWR_CR1_MRUDS | PWR_CR1_FPDS) /*!< Enter Stop mode (with main Regulator in under-drive mode) \
                                      when the CPU enters deepsleep */
#define LL_PWR_MODE_STOP_LPREGU                                                                   \
    PWR_CR1_LPDS /*!< Enter Stop mode (with low power Regulator ON) when the CPU enters deepsleep \
                  */
#define LL_PWR_MODE_STOP_LPREGU_UNDERDRIVE                                                      \
    (PWR_CR1_LPDS | PWR_CR1_LPUDS |                                                             \
     PWR_CR1_FPDS) /*!< Enter Stop mode (with low power Regulator in under-drive mode) when the \
 ...
 * @retval None
 */
__STATIC_INLINE void LL_PWR_EnableUnderDriveMode(void) { SET_BIT(PWR->CR1, PWR_CR1_UDEN); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_PWR_DisableUnderDriveMode(void) { CLEAR_BIT(PWR->CR1, PWR_CR1_UDEN); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_PWR_EnableOverDriveSwitching(void) { SET_BIT(PWR->CR1, PWR_CR1_ODSWEN); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_PWR_DisableOverDriveSwitching(void) { CLEAR_BIT(PWR->CR1, PWR_CR1_ODSWEN); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_PWR_EnableOverDriveMode(void) { SET_BIT(PWR->CR1, PWR_CR1_ODEN); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_PWR_DisableOverDriveMode(void) { CLEAR_BIT(PWR->CR1, PWR_CR1_ODEN); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_PWR_EnableFlashPowerDown(void) { SET_BIT(PWR->CR1, PWR_CR1_FPDS); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_PWR_DisableFlashPowerDown(void) { CLEAR_BIT(PWR->CR1, PWR_CR1_FPDS); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_PWR_EnableBkUpRegulator(void) { SET_BIT(PWR->CSR1, PWR_CSR1_BRE); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_PWR_DisableBkUpRegulator(void) { CLEAR_BIT(PWR->CSR1, PWR_CSR1_BRE); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_PWR_EnablePVD(void) { SET_BIT(PWR->CR1, PWR_CR1_PVDE); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_PWR_DisablePVD(void) { CLEAR_BIT(PWR->CR1, PWR_CR1_PVDE); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_PWR_EnableWakeUpPin(uint32_t WakeUpPin) { SET_BIT(PWR->CSR2, WakeUpPin); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_PWR_EnableInternalWakeUp(void) { SET_BIT(PWR->CSR1, PWR_CSR1_EIWUP); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_PWR_DisableInternalWakeUp(void) { CLEAR_BIT(PWR->CSR1, PWR_CSR1_EIWUP); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_PWR_ClearFlag_SB(void) { SET_BIT(PWR->CR1, PWR_CR1_CSBF); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_PWR_ClearFlag_WU6(void) { WRITE_REG(PWR->CR2, PWR_CR2_CWUPF6); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_PWR_ClearFlag_WU5(void) { WRITE_REG(PWR->CR2, PWR_CR2_CWUPF5); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_PWR_ClearFlag_WU4(void) { WRITE_REG(PWR->CR2, PWR_CR2_CWUPF4); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_PWR_ClearFlag_WU3(void) { WRITE_REG(PWR->CR2, PWR_CR2_CWUPF3); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_PWR_ClearFlag_WU2(void) { WRITE_REG(PWR->CR2, PWR_CR2_CWUPF2); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_PWR_ClearFlag_WU1(void) { WRITE_REG(PWR->CR2, PWR_CR2_CWUPF1); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_PWR_ClearFlag_UD(void) { WRITE_REG(PWR->CSR1, PWR_CSR1_UDRDY); }
