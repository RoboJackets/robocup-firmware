 ...
 */
uint32_t HAL_GetHalVersion(void) { return __STM32F7xx_HAL_VERSION; }
 ...
 * @retval None
 */
void HAL_EnableCompensationCell(void) { SYSCFG->CMPCR |= SYSCFG_CMPCR_CMP_PD; }
 ...
 * @retval None
 */
void HAL_EnableFMCMemorySwapping(void) { SYSCFG->MEMRMP |= SYSCFG_MEMRMP_SWP_FMC_0; }
 ...
 * @retval None
 */
void HAL_EnableMemorySwappingBank(void) { SET_BIT(SYSCFG->MEMRMP, SYSCFG_MEMRMP_SWP_FB); }
 ...
 * @retval None
 */
void HAL_DisableMemorySwappingBank(void) { CLEAR_BIT(SYSCFG->MEMRMP, SYSCFG_MEMRMP_SWP_FB); }
