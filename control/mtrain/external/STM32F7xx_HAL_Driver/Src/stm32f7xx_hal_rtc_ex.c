...
HAL_StatusTypeDef HAL_RTCEx_SetTamper(RTC_HandleTypeDef* hrtc, RTC_TamperTypeDef* sTamper) {
    ...
    hrtc->Instance->TAMPCR &= (uint32_t) ~(
        (uint32_t)sTamper->Tamper | (uint32_t)(sTamper->Tamper << 1) | (uint32_t)RTC_TAMPCR_TAMPTS |
        (uint32_t)RTC_TAMPCR_TAMPFREQ | (uint32_t)RTC_TAMPCR_TAMPFLT |
        (uint32_t)RTC_TAMPCR_TAMPPRCH | (uint32_t)RTC_TAMPCR_TAMPPUDIS |
        (uint32_t)RTC_TAMPCR_TAMPIE | (uint32_t)RTC_TAMPCR_TAMP1IE | (uint32_t)RTC_TAMPCR_TAMP2IE |
        (uint32_t)RTC_TAMPCR_TAMP3IE | (uint32_t)RTC_TAMPCR_TAMP1NOERASE |
        (uint32_t)RTC_TAMPCR_TAMP2NOERASE | (uint32_t)RTC_TAMPCR_TAMP3NOERASE |
        (uint32_t)RTC_TAMPCR_TAMP1MF | (uint32_t)RTC_TAMPCR_TAMP2MF | (uint32_t)RTC_TAMPCR_TAMP3MF);
