...
HAL_StatusTypeDef HAL_CAN_Init(CAN_HandleTypeDef* hcan) {
    ...
    if ((hcan->Instance->MSR & CAN_MSR_INAK) == CAN_MSR_INAK) {
        ...
        hcan->Instance->BTR = (uint32_t)((uint32_t)hcan->Init.Mode) | ((uint32_t)hcan->Init.SJW) |
                              ((uint32_t)hcan->Init.BS1) | ((uint32_t)hcan->Init.BS2) |
...
HAL_StatusTypeDef HAL_CAN_Transmit(CAN_HandleTypeDef* hcan, uint32_t Timeout) {
    ...
    if (((hcan->Instance->TSR & CAN_TSR_TME0) == CAN_TSR_TME0) ||
        ...
        if (hcan->pTxMsg->IDE == CAN_ID_STD) {
            ...
            hcan->Instance->sTxMailBox[transmitmailbox].TIR |=
                ((hcan->pTxMsg->ExtId << 3U) | hcan->pTxMsg->IDE | hcan->pTxMsg->RTR);
        }
        ...
        hcan->Instance->sTxMailBox[transmitmailbox].TDLR =
            (((uint32_t)hcan->pTxMsg->Data[3U] << 24U) | ((uint32_t)hcan->pTxMsg->Data[2U] << 16U) |
             ((uint32_t)hcan->pTxMsg->Data[1U] << 8U) | ((uint32_t)hcan->pTxMsg->Data[0U]));
        hcan->Instance->sTxMailBox[transmitmailbox].TDHR =
            (((uint32_t)hcan->pTxMsg->Data[7U] << 24U) | ((uint32_t)hcan->pTxMsg->Data[6U] << 16U) |
             ((uint32_t)hcan->pTxMsg->Data[5U] << 8U) | ((uint32_t)hcan->pTxMsg->Data[4U]));
...
HAL_StatusTypeDef HAL_CAN_Transmit_IT(CAN_HandleTypeDef* hcan) {
    ...
    if (((hcan->Instance->TSR & CAN_TSR_TME0) == CAN_TSR_TME0) ||
        ...
        __HAL_CAN_ENABLE_IT(
            hcan, CAN_IT_EWG | CAN_IT_EPV | CAN_IT_BOF | CAN_IT_LEC | CAN_IT_ERR | CAN_IT_TME);
    } else {
        /* Change CAN state */
        hcan->State = HAL_CAN_STATE_ERROR;
...
HAL_StatusTypeDef HAL_CAN_Sleep(CAN_HandleTypeDef* hcan) {
    ...
    /* Request Sleep mode */
    hcan->Instance->MCR =
        (((hcan->Instance->MCR) & (uint32_t)(~(uint32_t)CAN_MCR_INRQ)) | CAN_MCR_SLEEP);
