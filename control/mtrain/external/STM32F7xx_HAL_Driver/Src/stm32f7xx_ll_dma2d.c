...
#define IS_LL_DMA2D_ALPHAINV(ALPHA) \
    (((ALPHA) == LL_DMA2D_ALPHA_REGULAR) || ((ALPHA) == LL_DMA2D_ALPHA_INVERTED))

#define IS_LL_DMA2D_RBSWAP(RBSWAP) \
    (((RBSWAP) == LL_DMA2D_RB_MODE_REGULAR) || ((RBSWAP) == LL_DMA2D_RB_MODE_SWAP))
    ...
    if (LayerIdx == 0U) {
        ...
        MODIFY_REG(DMA2Dx->BGPFCCR,
                   ...
                   ((DMA2D_LayerCfg->Alpha << DMA2D_BGPFCCR_ALPHA_Pos) |
                    DMA2D_LayerCfg->RBSwapMode | DMA2D_LayerCfg->AlphaInversionMode |
...
#else
        /* Configure the background Alpha value, Alpha mode, CLUT size, CLUT Color mode and Color
         * mode */
        MODIFY_REG(DMA2Dx->BGPFCCR,
        ...
        LL_DMA2D_BGND_SetColor(DMA2Dx, DMA2D_LayerCfg->Red, DMA2D_LayerCfg->Green,
                               DMA2D_LayerCfg->Blue);
        ...
        MODIFY_REG(DMA2Dx->FGPFCCR,
                   ...
                   ((DMA2D_LayerCfg->Alpha << DMA2D_FGPFCCR_ALPHA_Pos) |
                    ...
                    DMA2D_LayerCfg->CLUTColorMode | DMA2D_LayerCfg->ColorMode));
#else
        /* Configure the foreground Alpha value, Alpha mode, CLUT size, CLUT Color mode and Color
         * mode */
        MODIFY_REG(DMA2Dx->FGPFCCR,
        ...
        LL_DMA2D_FGND_SetColor(DMA2Dx, DMA2D_LayerCfg->Red, DMA2D_LayerCfg->Green,
                               DMA2D_LayerCfg->Blue);
