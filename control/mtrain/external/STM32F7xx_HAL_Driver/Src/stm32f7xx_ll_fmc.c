...
#define PCR_CLEAR_MASK                                                                          \
    ((uint32_t)(FMC_PCR_PWAITEN | FMC_PCR_PBKEN | FMC_PCR_PTYP | FMC_PCR_PWID | FMC_PCR_ECCEN | \
...
#define SDTR_CLEAR_MASK                                                                            \
    ((uint32_t)(FMC_SDTR1_TMRD | FMC_SDTR1_TXSR | FMC_SDTR1_TRAS | FMC_SDTR1_TRC | FMC_SDTR1_TWR | \
...
HAL_StatusTypeDef FMC_NAND_Init(FMC_NAND_TypeDef* Device, FMC_NAND_InitTypeDef* Init) {
    ...
    MODIFY_REG(
        Device->PCR, PCR_CLEAR_MASK,
        (Init->Waitfeature | FMC_PCR_MEMORY_TYPE_NAND | Init->MemoryDataWidth |
         Init->EccComputation | Init->ECCPageSize | ((Init->TCLRSetupTime) << FMC_PCR_TCLR_Pos) |
