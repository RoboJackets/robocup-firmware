...
#define IS_LL_DMA_CHANNEL(__VALUE__)                                             \
    (((__VALUE__) == LL_DMA_CHANNEL_0) || ((__VALUE__) == LL_DMA_CHANNEL_1) ||   \
     ...
     ((__VALUE__) == LL_DMA_CHANNEL_8) || ((__VALUE__) == LL_DMA_CHANNEL_9) ||   \
     ((__VALUE__) == LL_DMA_CHANNEL_10) || ((__VALUE__) == LL_DMA_CHANNEL_11) || \
     ((__VALUE__) == LL_DMA_CHANNEL_12) || ((__VALUE__) == LL_DMA_CHANNEL_13) || \
     ((__VALUE__) == LL_DMA_CHANNEL_14) || ((__VALUE__) == LL_DMA_CHANNEL_15))
...
#define IS_LL_DMA_ALL_STREAM_INSTANCE(INSTANCE, STREAM)                                          \
    ((((INSTANCE) == DMA1) && (((STREAM) == LL_DMA_STREAM_0) || ((STREAM) == LL_DMA_STREAM_1) || \
     ...
     (((INSTANCE) == DMA2) && (((STREAM) == LL_DMA_STREAM_0) || ((STREAM) == LL_DMA_STREAM_1) || \
                               ((STREAM) == LL_DMA_STREAM_2) || ((STREAM) == LL_DMA_STREAM_3) || \
                               ((STREAM) == LL_DMA_STREAM_4) || ((STREAM) == LL_DMA_STREAM_5) || \
                               ((STREAM) == LL_DMA_STREAM_6) || ((STREAM) == LL_DMA_STREAM_7) || \
                               ((STREAM) == LL_DMA_STREAM_ALL))))
