...
#define IS_LL_RCC_USART_CLKSOURCE(__VALUE__)                                                 \
    (((__VALUE__) == LL_RCC_USART1_CLKSOURCE) || ((__VALUE__) == LL_RCC_USART2_CLKSOURCE) || \
     ((__VALUE__) == LL_RCC_USART3_CLKSOURCE) || ((__VALUE__) == LL_RCC_USART6_CLKSOURCE))

#define IS_LL_RCC_UART_CLKSOURCE(__VALUE__)                                                \
    (((__VALUE__) == LL_RCC_UART4_CLKSOURCE) || ((__VALUE__) == LL_RCC_UART5_CLKSOURCE) || \
     ((__VALUE__) == LL_RCC_UART7_CLKSOURCE) || ((__VALUE__) == LL_RCC_UART8_CLKSOURCE))
...
#define IS_LL_RCC_SDMMC_CLKSOURCE(__VALUE__) \
    (((__VALUE__) == LL_RCC_SDMMC1_CLKSOURCE) || ((__VALUE__) == LL_RCC_SDMMC2_CLKSOURCE))
#else
...
ErrorStatus LL_RCC_DeInit(void) {
    ...
    CLEAR_BIT(vl_mask, (RCC_CR_HSEON | RCC_CR_HSEBYP | RCC_CR_PLLON | RCC_CR_CSSON |
                        RCC_CR_PLLSAION | RCC_CR_PLLI2SON));
...
uint32_t RCC_PLLSAI_GetFreqDomain_SAI(void) {
    ...
    */
    ...
    return __LL_RCC_CALC_PLLSAI_SAI_FREQ(pllinputfreq, LL_RCC_PLL_GetDivider(),
                                         LL_RCC_PLLSAI_GetN(), LL_RCC_PLLSAI_GetQ(),
...
uint32_t RCC_PLLSAI_GetFreqDomain_LTDC(void) {
    ...
    */
    ...
    return __LL_RCC_CALC_PLLSAI_LTDC_FREQ(pllinputfreq, LL_RCC_PLL_GetDivider(),
                                          LL_RCC_PLLSAI_GetN(), LL_RCC_PLLSAI_GetR(),
