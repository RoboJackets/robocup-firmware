...
void interruptin_init_ex(pin_name pin, void (*function)(), pull_type pull, interrupt_mode mode) {
    GPIO_InitTypeDef pin_structure = {};
    pin_structure.Pin = pin.pin;
...
void interruptin_deinit(pin_name pin) { HAL_GPIO_DeInit(pin.port, pin.pin); }

int interruptin_read(pin_name pin) { return HAL_GPIO_ReadPin(pin.port, pin.pin); }