...
void interruptin_init_ex(PinName pin, void (*function)(), PullType pull, interrupt_mode mode) {
    GPIO_InitTypeDef pin_structure = {};
    pin_structure.Pin = pin.pin;
...
int interruptin_read(PinName pin) { return HAL_GPIO_ReadPin(pin.port, pin.pin); }
