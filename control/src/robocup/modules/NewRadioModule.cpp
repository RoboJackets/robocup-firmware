...
NewRadioModule::NewRadioModule(LockedStruct<BatteryVoltage>& batteryVoltage):GenericModule(kPeriod, "newRadio", kPriority),uart(UARTBus7), batteryVoltage(batteryVoltage){
